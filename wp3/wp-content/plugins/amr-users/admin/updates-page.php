...
function amr_users_license_prompt() {
	amr_flag_error (__('Please enter your license keys'.' <a href="">'.admin_url('admin.php?page=amr_updates_page').'</a>'));
}
...
// check if we should be doing any form processing and was the post from this page
	...
	<div class="wrap">
		...
		'<a title="'.__('See plugins','amr-users').'" href="'.AMR_USERS_STORE_URL.'">'.AMR_USERS_STORE_URL.'</a>'); ?></p>
		<p><?php _e('Please click "check license" to see if it is still valid.','amr-users'); ?><p>
