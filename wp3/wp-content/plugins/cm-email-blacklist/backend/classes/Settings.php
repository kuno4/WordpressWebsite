...
class CMEB_Settings {
    ...
    public static function getOptionsConfig() {
        ...
        'title' => 'White List',
        'desc' => 'When enabled, domains on the White list will NOT be blocked. E-mails coming from other domains will be rejected.'
        ),
        ...
        'desc' => 'When enabled, domains on the Free Domain list will be blocked. It is a list containing all the domains that provide free email. This list also includes gmail.com and other popular services.'
        ),
        ...
        'category'		=> 'cmeb_general',
        'subcategory'	=> 'cmeb_general',
        'title'			=> 'User E-Mail Black List',
        'desc'			=> 'When enabled, the e-mails on the Black list will be marked as invalid. E-mail validation is checked before domain validation.',
        ),
        ...
        'type'			 => self::TYPE_STRING,
        'default'		 => 'E-mail is blacklisted',
        'category'		 => 'cmeb_labels',
        'subcategory'	 => 'cmeb_labels',
        'title'			 => 'E-mail is in the Black list',
        'desc'			 => 'Label for \'E-mail is the black list\' message',
        ),
