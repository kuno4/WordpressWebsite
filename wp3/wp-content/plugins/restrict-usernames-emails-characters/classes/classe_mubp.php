	...
	class ben_plug_restrict_usernames_emails_characters_mu_bp extends ben_plug_restrict_usernames_emails_characters_CHARS {
		...
		function wpmubp__ben( $result ){
			...
			*/
			...
			$er_name = $this->options_Tw('err_mp_names_limit') != '' && __( 'This username is not allowed, choose another please.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_names_limit') : __( 'This username is not allowed, choose another please.','restrict-usernames-emails-characters' );	 
			...
			$er_digits_less = $this->options_Tw('err_mp_digits_less') != '' && __( "The digits must be less than the characters in username.",'restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_digits_less'): __( "The digits must be less than the characters in username.",'restrict-usernames-emails-characters' );	 
			$er_space = $this->options_Tw('err_mp_spaces') != '' && __( "It's not allowed to use spaces in username.",'restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_spaces'): __( "It's not allowed to use spaces in username.",'restrict-usernames-emails-characters' );	 
			$er_just_num = $this->options_Tw('err_mp_names_num') != '' && __( "You can't register with just numbers.",'restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_names_num'): __( "You can't register with just numbers.",'restrict-usernames-emails-characters' );	 
			...
			$er_name_not_email = $this->options_Tw('err_mp_name_not_email') != '' && __( 'Do not allow usernames that are email addresses.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_name_not_email'): __( 'Do not allow usernames that are email addresses.','restrict-usernames-emails-characters' );	 
			$er_uppercase = $this->options_Tw('err_mp_uppercase') != '' && __( 'No uppercase (A-Z) in username.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_uppercase'): __( 'No uppercase (A-Z) in username.','restrict-usernames-emails-characters' );	 
			...
			$er_username_empty = $this->options_Tw('err_mp_empty') != '' && __( 'Please enter a username.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_empty'): __( 'Please enter a username.','restrict-usernames-emails-characters' );	 
			$er_exist_login = $this->options_Tw('err_mp_exist_login') != '' && __( 'This username is already registered. Please choose another one.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_exist_login'): __( 'This username is already registered. Please choose another one.','restrict-usernames-emails-characters' );	 
			
			$er_empty_user_email = $this->options_Tw('err_mp_empty_user_email') != '' && __( 'Please type your email address.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_empty_user_email'): __( 'Please type your email address.','restrict-usernames-emails-characters' );	 
			$er_invalid_user_email = $this->options_Tw('err_mp_invalid_user_email') != '' && __( 'The email address isn&#8217;t correct.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_invalid_user_email'): __( 'The email address isn&#8217;t correct.','restrict-usernames-emails-characters' );	 
			$er_exist_email = $this->options_Tw('err_mp_exist_user_email') != '' && __( 'This email is already registered, please choose another one.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_exist_user_email'): __( 'This email is already registered, please choose another one.','restrict-usernames-emails-characters' );	 
			$er_emails_limit = $this->options_Tw('err_mp_emails_limit') != '' && __( 'This email is not allowed, choose another please.','restrict-usernames-emails-characters') ? $this->options_Tw('err_mp_emails_limit'): __( 'This email is not allowed, choose another please.','restrict-usernames-emails-characters' );	 
			...
			if ( !validate_username( $username ) && !$this->ben_username_empty($username) || $this->valid_charts && !$this->can_create_users() || $this->invalid_chars_allow && !$this->can_create_users() )
			...
			if ( !username_exists( $username ) && !$this->ben_username_empty($username) ){
				if ( $this->func_space_s_e_m($username) && !$this->can_create_users() )
				$new_error->add('user_name', __($er_start_end_space, 'restrict-usernames-emails-characters'));
			}
			...
			*/
			...
			$new_error->add('user_email', __($er_empty_user_email,'restrict-usernames-emails-characters'));
		
			if ($this->invalid__user_email)
			$new_error->add('user_email', __($er_invalid_user_email,'restrict-usernames-emails-characters'));
		
			if ($this->exist__user_email)
			$new_error->add('user_email', __($er_exist_email,'restrict-usernames-emails-characters'));
		
			if ( $this->restricted_emails || $this->restricted_domain_emails )
			$new_error->add('user_email', __($er_emails_limit, 'restrict-usernames-emails-characters'));
			// emails error
