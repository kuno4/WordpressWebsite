                          ...
                          <div class="rm-modal-container">
                            <div class="rm-directory-container dbfl">
                                <div class="rm-publish-directory-col rm-difl">
                                    ...
                                    <div class="rm-publish-text"><?php _e('Planning to publish events calendar on your site? Use EventPrime to create simple or complex events and manage bookings. EventPrime is free and you can get started within minutes. ', 'registrationmagic-gold'); ?></div>
                                    ...
                                    <a href="<?php echo $data->ep_install_url; ?>" class="pg-install-now"><?php _e('Install Now', 'registrationmagic-gold') ?></a>     
                                </div>
            ...
            foreach ($data->latest_subs as $submission):
                ...
                <div class="rm-grid-sidebar-card dbfl <?php echo $submission->is_read? '' : "rm-grid-user-new"; ?>">
                    ...
                    <div class="rm-grid-card-content difl">
                        ...
                        <div class="rm-grid-card-content-subtext dbfl"><?php echo RM_Utilities::localize_time($submission->submitted_on); ?></div></div>
                    </a>
                </div>
                <?php
            endforeach;
