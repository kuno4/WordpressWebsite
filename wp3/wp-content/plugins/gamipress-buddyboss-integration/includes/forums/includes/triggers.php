...
function gamipress_bbp_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'BuddyBoss Forums', 'gamipress-buddyboss-integration' )] = array(
        'gamipress_bbp_new_forum'               => __( 'Create a new forum', 'gamipress-buddyboss-integration' ),

        'gamipress_bbp_new_topic'               => __( 'Create a new topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_specific_new_topic'      => __( 'Create a new topic on a specific forum', 'gamipress-buddyboss-integration' ),

        'gamipress_bbp_new_reply'               => __( 'Reply to a topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_specific_new_reply'      => __( 'Reply to a specific topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_specific_forum_reply'    => __( 'Reply to any topic of a specific forum', 'gamipress-buddyboss-integration' ),

        'gamipress_bbp_favorite_topic'          => __( 'Favorite a topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_specific_favorite_topic' => __( 'Favorite a specific topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_specific_forum_favorite_topic' => __( 'Favorite any topic on a specific forum', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_get_favorite_topic'      => __( 'Get a new favorite on a topic', 'gamipress-buddyboss-integration' ),

        'gamipress_bbp_delete_forum'            => __( 'Delete a forum', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_delete_topic'            => __( 'Delete a topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_delete_reply'            => __( 'Delete a reply', 'gamipress-buddyboss-integration' ),
    );

    return $triggers;

}
add_filter( 'gamipress_buddyboss_activity_triggers', 'gamipress_bbp_activity_triggers' );
...
function gamipress_bbp_specific_activity_trigger_label( $specific_activity_trigger_labels ) {
    ...
    $specific_activity_trigger_labels['gamipress_bbp_specific_new_topic'] = __( 'Create a topic on %s forum', 'gamipress-buddyboss-integration' );
    $specific_activity_trigger_labels['gamipress_bbp_specific_new_reply'] = __( 'Reply on %s', 'gamipress-buddyboss-integration' );
    $specific_activity_trigger_labels['gamipress_bbp_specific_forum_reply'] = __( 'Reply any topic on %s forum', 'gamipress-buddyboss-integration' );
    $specific_activity_trigger_labels['gamipress_bbp_specific_favorite_topic'] = __( 'Favorite %s', 'gamipress-buddyboss-integration' );
    $specific_activity_trigger_labels['gamipress_bbp_specific_forum_favorite_topic'] = __( 'Favorite any topic on %s forum', 'gamipress-buddyboss-integration' );
